      ...
      <div className="container">
        <div className="content-section">
          <div className="text-section">
            <h1 className="head1" >I'm Shankar, </h1>
            ...
            <div className="about-me">
              ...
              <p>
                ...
                Django, React, and web development tools like HTML, CSS,
                JavaScript and front-end frameworks like ReactJs and CSS Frameworks like Bootstrap. Experienced in database management using PostgreSQL
            ...
            <div className="follow">
              ...
              <div className="buttons">
                <a
                  href="https://www.linkedin.com/in/shankar-rathod-ab209a2a9/"
                  target="_blank"
                >
                  <button>LinkedIn</button>
                </a>
                <a href="https://github.com/shakarrathod9632" target="_blank">
                  <button>GitHub</button>
                </a>
                <a
                  href="https://www.instagram.com/shankar_rathod_85/"
                  target="_blank"
                >
          ...
          {/* <div className="image-section">
            <img src={testPng} alt="shankar's photo" />
          </div> */}
        </div>
      </div>
    </div>
